...
const Subscriptions = () => {
  ...
  return (
    ...
    <div className='dashboard-container w-100'>
            ...
            <div className={clsx(!mobileWidth && 'pl-4 pt-2 pb-2 pr-4', mobileWidth && 'pt-2 pb-2 pl-2')}>
                <p className={clsx(mobileWidth && 'd-heading1-res', !mobileWidth && 'pl-2', 'd-headingtop pt-2')}>Manage your subscription</p>
                <br></br>
                <p className={clsx(mobileWidth && 'd-title-res', 'd-subtitle')}>Upgrade your plan, change your payment method and much more.</p>
                <br></br>
                </div>
                <div className="card py-10"  style={{width:"60rem", margin:"3px 3px 3px 21px"}}>
  ...
  <div className="row no-gutters">
    ...
    <div className="card-body">
       ...
       Unlimited access to lorem ipsum dolor sit amet, consectetur adipiscing elit</p>
...
<div className="card "  style={{width:"60rem", margin:"20px 3px 3px 21px"}}>
  <div className="row no-gutters">
