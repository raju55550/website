...
const Uploadfile = () => {
  ...
  const handleSubmit = (e) => {
    ...
    axios
      .post(`${API_BASE_URL}/media/create`, formdata, {
          ...
          <div className='d-flex mt-4 alignselect'>
            <div className='d-flex flex-column position-relative'>
              <select
                className={clsx(
                  'selectone',
                  mobileWidth && 'responsive-select'
                )}
                onChange={(e) => onChange('translateTo', e.target.value)}
              >
                <option className='optioncss' value='en'>
                  English
                </option>
                <option className='optioncss' value='ar'>
                  Arabic
                </option>
              </select>
            ...
            <div className='d-flex flex-column position-relative'>
              <select
                className={clsx('select', mobileWidth && 'responsive-select')}
              ...
              >
                ...
                <option className='optioncss' value='fr'>
                  French
                </option>
                <option className='optioncss' value='English'>
                  Spanish
                </option>
                <option className='optioncss' value='English'>
                  Chinese
          ...
          <div className='upload-box1 d-flex justify-content-center p-3'>
              ...
              >
                <div>
                  ...
                  <p
                    className={clsx(
                      'subheadingupload',
                      mobileWidth && 'responsive-text2'
                    )}
                  >
                    MP3, WAV, MP4 AVI file are allowed.
                  </p>
                  <div className='drag-and-drop text-center'>
                    <div className='image-upload'>
                      <label
                        htmlFor='file-input'
                        className={clsx(
                          !mobileWidth && 'mt-5 mb-3',
                          mobileWidth && 'mt-4 mb-2',
                          'text-center'
                        )}
                      >
                        <img
                    ...
                    <p className={clsx('heading5', mobileWidth && 'res-head5')}>
                      Drag and drop or browse to choose a file{' '}
                    </p>
                    <p className={clsx('heading6', mobileWidth && 'res-head6')}>
                      Maxiumum size: 50KB
                    </p>
                  </div>
                </div>
            ...
            <div
              className={clsx(
                !mobileWidth && 'w-45',
                mobileWidth &&
                  'w-45 d-flex align-items-center flex-column justify-content-start'
              )}
            >
              <p
                className={clsx(
              ...
              >
                Audio will be dubbed to Arabic
              </p>
              <div
                className={clsx(
                  mobileWidth && 'drag-and-drop2-res',
                  'drag-and-drop3 d-flex align-items-center justify-content-center'
                )}
              >
                <p
                  className={clsx('headingmsg p-1', mobileWidth && 'res-head5')}
                >
